...
public partial class DashboardViewModel : ObservableObject
{
    ...
    public async Task InitializeAsync()
    {
        ...
        var allTiles = new List<DashboardTile>
        {
            ...
            new("Quality Control", "Inspect incoming goods and GRNs", "shield.png", "quality-control", "#EF4444"),
        ...
        var allowed = new[]
        {
            ...
            new[] { PermissionCodes.QualityControlInspect, PermissionCodes.QualityControlApprove },
